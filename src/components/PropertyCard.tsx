...
export function PropertyCard({ property, onRequestTour }: PropertyCardProps) {
  ...
  const generateTourMessage = () => {
    const message = `Hello, I am interested in scheduling a tour for the property at ${property.location.neighborhood}, ${property.location.city}. It is a ${property.bedrooms} bedroom, ${property.bathrooms} bathroom apartment. My availability is flexible. Please let me know what times work best for you. Thank you!`;
      ...
      <Card className="group overflow-hidden hover:shadow-lg transition-shadow duration-300 bg-white">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button onClick={generateTourMessage}>Request a Tour</Button>
          </div>
        </div>
<<<<<<< HEAD
      </Card>
...
>>>>>>> feature/anthropic-nlp-integration
  );
}